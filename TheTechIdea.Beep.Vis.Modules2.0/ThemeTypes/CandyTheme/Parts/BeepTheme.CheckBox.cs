...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CandyTheme
    {
        ...
        public Font CheckBoxFont { get; set; } = new Font("Segoe UI", 10.5f, FontStyle.Regular);
        public Font CheckBoxCheckedFont { get; set; } = new Font("Comic Sans MS", 10.5f, FontStyle.Bold);
    }
}
