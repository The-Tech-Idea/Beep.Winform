...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CandyTheme
    {
        ...
        public Font SideMenuTitleFont { get; set; } = new Font("Comic Sans MS", 13f, FontStyle.Bold);
        public Font SideMenuSubTitleFont { get; set; } = new Font("Segoe UI", 11f, FontStyle.Italic);
        public Font SideMenuTextFont { get; set; } = new Font("Segoe UI", 10.5f, FontStyle.Regular);
