...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CandyTheme
    {
        ...
        public Font SwitchTitleFont { get; set; } = new Font("Comic Sans MS", 11f, FontStyle.Bold);
        public Font SwitchSelectedFont { get; set; } = new Font("Comic Sans MS", 11f, FontStyle.Bold);
        public Font SwitchUnSelectedFont { get; set; } = new Font("Segoe UI", 10.5f, FontStyle.Regular);
