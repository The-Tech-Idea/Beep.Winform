...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CyberpunkNeonTheme
    {
        ...
        public Font ListTitleFont { get; set; } = new Font("Consolas", 12f, FontStyle.Bold);
        public Font ListSelectedFont { get; set; } = new Font("Consolas", 11f, FontStyle.Bold);
        public Font ListUnSelectedFont { get; set; } = new Font("Consolas", 11f, FontStyle.Regular);
