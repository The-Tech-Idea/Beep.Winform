...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CyberpunkNeonTheme
    {
        ...
        public Font MenuTitleFont { get; set; } = new Font("Consolas", 13f, FontStyle.Bold);
        public Font MenuItemSelectedFont { get; set; } = new Font("Consolas", 12f, FontStyle.Bold);
        public Font MenuItemUnSelectedFont { get; set; } = new Font("Consolas", 12f, FontStyle.Regular);
