...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CyberpunkNeonTheme
    {
        ...
        public Font StatsTitleFont { get; set; } = new Font("Consolas", 14f, FontStyle.Bold);
        public Font StatsSelectedFont { get; set; } = new Font("Consolas", 13f, FontStyle.Bold | FontStyle.Italic);
        public Font StatsUnSelectedFont { get; set; } = new Font("Consolas", 13f, FontStyle.Regular);
