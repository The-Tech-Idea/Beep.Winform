...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CyberpunkNeonTheme
    {
        ...
        public Font TaskCardTitleFont { get; set; } = new Font("Consolas", 16f, FontStyle.Bold);
        public Font TaskCardSelectedFont { get; set; } = new Font("Consolas", 14f, FontStyle.Bold | FontStyle.Italic);
        public Font TaskCardUnSelectedFont { get; set; } = new Font("Consolas", 14f, FontStyle.Regular);
