...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class CyberpunkNeonTheme
    {
        ...
        public Font TestimoniaTitleFont { get; set; } = new Font("Consolas", 14f, FontStyle.Bold);
        public Font TestimoniaSelectedFont { get; set; } = new Font("Consolas", 12f, FontStyle.Bold | FontStyle.Italic);
        public Font TestimoniaUnSelectedFont { get; set; } = new Font("Consolas", 12f, FontStyle.Regular);
