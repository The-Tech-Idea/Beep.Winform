...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class DefaultTheme
    {
        ...
        public Font TextBoxHoverFont { get; set; } = new Font("Segoe UI", 10f, FontStyle.Regular);
        public Font TextBoxSelectedFont { get; set; } = new Font("Segoe UI", 10f, FontStyle.Regular);
    }
}
