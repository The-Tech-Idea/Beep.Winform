...
namespace TheTechIdea.Beep.Vis.Modules
{
    ...
    {
        // Card Colors & Fonts
        public TypographyStyle CardTitleFont { get; set; } = ThemeUtils.ConvertFontToTypographyStyle(new FontFamily("Segoe UI"), 14, FontStyle.Bold);
        ...
        public TypographyStyle CardSubTitleFont { get; set; } = ThemeUtils.ConvertFontToTypographyStyle(new FontFamily("Segoe UI"), 10, FontStyle.Regular);
