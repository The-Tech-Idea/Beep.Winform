...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class FlatDesignTheme
    {
        ...
        public Color StarRatingBorderColor { get; set; } = Color.Goldenrod;
        public Color StarRatingFillColor { get; set; } = Color.Gold;
        public Color StarRatingHoverForeColor { get; set; } = Color.DarkOrange;
        ...
        public Color StarRatingSelectedForeColor { get; set; } = Color.Orange;
