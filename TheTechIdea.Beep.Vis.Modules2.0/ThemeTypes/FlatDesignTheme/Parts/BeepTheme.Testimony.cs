...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class FlatDesignTheme
    {
        ...
        public Font TestimoniaTitleFont { get; set; } = new Font("Segoe UI", 12, FontStyle.Bold);
        public Font TestimoniaSelectedFont { get; set; } = new Font("Segoe UI", 11, FontStyle.Bold);
        public Font TestimoniaUnSelectedFont { get; set; } = new Font("Segoe UI", 11, FontStyle.Regular);
