...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class ForestTheme
    {
        ...
        public Font StatsTitleFont { get; set; } = new Font("Segoe UI", 16f, FontStyle.Bold);
        public Font StatsSelectedFont { get; set; } = new Font("Segoe UI", 14f, FontStyle.Bold);
        public Font StatsUnSelectedFont { get; set; } = new Font("Segoe UI", 14f, FontStyle.Regular);
