...
<<<<<<< HEAD
        public Font TestimoniaTitleFont { get; set; } = new Font("Segoe UI", 12f, FontStyle.Bold);
        public Font TestimoniaSelectedFont { get; set; } = new Font("Segoe UI", 10f, FontStyle.Bold);
        public Font TestimoniaUnSelectedFont { get; set; } = new Font("Segoe UI", 10f, FontStyle.Regular);
