...
//<<<<<<< HEAD
        ...
        public Color TextBoxBorderColor { get; set; } = Color.FromArgb(204, 204, 204);
        public Color TextBoxHoverBorderColor { get; set; } = Color.FromArgb(0, 120, 212);
        public Color TextBoxHoverBackColor { get; set; } = Color.White;
        public Color TextBoxHoverForeColor { get; set; } = Color.Black;
        public Color TextBoxSelectedBorderColor { get; set; } = Color.FromArgb(0, 120, 212);
        ...
        public TypographyStyle  TextBoxHoverFont { get; set; } = ThemeUtils.ConvertFontToTypographyStyle("Segoe UI", 10, FontStyle.Italic);
