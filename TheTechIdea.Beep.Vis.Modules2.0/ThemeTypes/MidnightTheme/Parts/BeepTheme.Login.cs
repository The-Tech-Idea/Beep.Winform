...
<<<<<<< HEAD
        ...
        public Font LoginTitleFont { get; set; } = new Font("Segoe UI", 18f, FontStyle.Bold);
        public Color LoginSubtitleColor { get; set; } = Color.LightGray;
        public Font LoginSubtitleFont { get; set; } = new Font("Segoe UI", 14f, FontStyle.Regular);
        public Color LoginDescriptionColor { get; set; } = Color.Gray;
        public Font LoginDescriptionFont { get; set; } = new Font("Segoe UI", 12f, FontStyle.Regular);
        public Color LoginLinkColor { get; set; } = Color.DodgerBlue;
        public Font LoginLinkFont { get; set; } = new Font("Segoe UI", 12f, FontStyle.Underline);
