...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class NeumorphismTheme
    {
        ...
        public Color AppBarLabelBackColor { get; set; } = Color.FromArgb(230, 230, 235); // Transparent for labels
        public Color AppBarTitleForeColor { get; set; } = Color.FromArgb(50, 50, 60); // Dark gray for title
        public Color AppBarTitleBackColor { get; set; } = Color.FromArgb(230, 230, 235); // Transparent for title background
        public Color AppBarSubTitleForeColor { get; set; } = Color.FromArgb(80, 80, 90); // Medium gray for subtitle
        public Color AppBarSubTitleBackColor { get; set; } = Color.FromArgb(230, 230, 235); // Transparent for subtitle background
