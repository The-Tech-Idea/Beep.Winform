...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class OceanTheme
    {
        ...
        public TypographyStyle LabelFont { get; set; } = new TypographyStyle() { FontSize = 12, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(0, 80, 120) };
        public TypographyStyle SubLabelFont { get; set; } = new TypographyStyle() { FontSize = 10, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(0, 105, 148) };
