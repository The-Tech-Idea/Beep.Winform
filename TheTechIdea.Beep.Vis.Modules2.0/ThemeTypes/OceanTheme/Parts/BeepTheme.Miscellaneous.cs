...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class OceanTheme
    {
        ...
        public Color PrimaryTextColor { get; set; } = Color.FromArgb(240, 245, 255); // Light off-white for primary text
        public Color SecondaryTextColor { get; set; } = Color.FromArgb(150, 180, 200); // Soft aqua for secondary text
        public Color AccentTextColor { get; set; } = Color.FromArgb(100, 200, 180); // Bright teal for accents
        ...
        public bool ApplyThemeToIcons { get; set; } = true; // Apply ocean colors to icons
        public Color ShadowColor { get; set; } = Color.FromArgb(120, 100, 200, 180); // Semi-transparent bright teal for shadows
        ...
        public Color FocusIndicatorColor { get; set; } = Color.FromArgb(150, 180, 200); // Soft aqua for focus indicators
        public bool IsDarkTheme { get; set; } = true; // Ocean theme is dark
    }
}