...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class OceanTheme
    {
        ...
        public TypographyStyle SideMenuTitleFont { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.White };
        public TypographyStyle SideMenuSubTitleFont { get; set; } = new TypographyStyle() { FontSize = 12f, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(200, 255, 255) };
        public TypographyStyle SideMenuTextFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(200, 255, 255) };
        ...
        public Color SideMenuTitleBackColor { get; set; } = Color.FromArgb(0, 150, 200);
        public TypographyStyle SideMenuTitleStyle { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.White };
        public Color SideMenuSubTitleTextColor { get; set; } = Color.FromArgb(200, 255, 255);
        public Color SideMenuSubTitleBackColor { get; set; } = Color.FromArgb(0, 150, 200);
        public TypographyStyle SideMenuSubTitleStyle { get; set; } = new TypographyStyle() { FontSize = 12f, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(200, 255, 255) };
