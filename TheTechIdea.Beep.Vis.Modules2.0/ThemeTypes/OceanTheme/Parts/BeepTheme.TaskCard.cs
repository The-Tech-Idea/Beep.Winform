...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class OceanTheme
    {
        ...
        public TypographyStyle TaskCardTitleFont { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.White };
        ...
        public TypographyStyle TaskCardUnSelectedFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(200, 255, 255) };
        ...
        public TypographyStyle TaskCardTitleStyle { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.White };
        ...
        public TypographyStyle TaskCardSubStyleStyle { get; set; } = new TypographyStyle() { FontSize = 12f, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(200, 255, 255) };
        ...
        public TypographyStyle TaskCardMetricTextStyle { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Bold, TextColor = Color.White };
