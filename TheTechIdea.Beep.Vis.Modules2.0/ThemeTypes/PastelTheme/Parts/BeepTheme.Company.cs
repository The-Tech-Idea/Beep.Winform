...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class PastelTheme
    {
        ...
        public TypographyStyle CompanyTitleFont { get; set; } = new TypographyStyle() { FontSize = 16, FontWeight = FontWeight.Bold, TextColor = Color.FromArgb(80, 80, 80) };
        public Color CompanySubtitleColor { get; set; } = Color.FromArgb(120, 120, 120);
        public TypographyStyle CompanySubTitleFont { get; set; } = new TypographyStyle() { FontSize = 12, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(120, 120, 120) };
        public Color CompanyDescriptionColor { get; set; } = Color.FromArgb(150, 150, 150);
        public TypographyStyle CompanyDescriptionFont { get; set; } = new TypographyStyle() { FontSize = 11, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(150, 150, 150) };
        public Color CompanyLinkColor { get; set; } = Color.FromArgb(245, 183, 203);
        public TypographyStyle CompanyLinkFont { get; set; } = new TypographyStyle() { FontSize = 11, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(245, 183, 203), IsUnderlined = true };
