...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class PastelTheme
    {
        ...
        public Color PrimaryTextColor { get; set; } = Color.FromArgb(60, 60, 60); // Dark gray for primary text
        public Color SecondaryTextColor { get; set; } = Color.FromArgb(100, 100, 100); // Medium gray for secondary text
        public Color AccentTextColor { get; set; } = Color.FromArgb(120, 160, 190); // Pastel blue for accents
        ...
        public bool ApplyThemeToIcons { get; set; } = true; // Apply pastel colors to icons
        public Color ShadowColor { get; set; } = Color.FromArgb(120, 180, 200, 220); // Semi-transparent pastel lavender for shadows
        ...
        public Color FocusIndicatorColor { get; set; } = Color.FromArgb(120, 160, 190); // Pastel blue for focus indicators
        public bool IsDarkTheme { get; set; } = false; // Pastel theme is light
    }
}