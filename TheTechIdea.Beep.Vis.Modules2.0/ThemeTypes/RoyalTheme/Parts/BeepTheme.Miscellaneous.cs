...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class RoyalTheme
    {
        ...
        public Color SecondaryTextColor { get; set; } = Color.FromArgb(200, 200, 200);
        public Color AccentTextColor { get; set; } = Color.FromArgb(255, 193, 7);
        ...
        public Color FocusIndicatorColor { get; set; } = Color.FromArgb(255, 193, 7);
