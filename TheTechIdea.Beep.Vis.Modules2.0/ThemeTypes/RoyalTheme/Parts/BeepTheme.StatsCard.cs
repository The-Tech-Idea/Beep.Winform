...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class RoyalTheme
    {
        ...
        public Color StatsCardBackColor { get; set; } = Color.FromArgb(33, 37, 41);
        public Color StatsCardForeColor { get; set; } = Color.FromArgb(200, 200, 200);
        public Color StatsCardBorderColor { get; set; } = Color.FromArgb(108, 117, 125);
        ...
        public Color StatsCardSubTitleForeColor { get; set; } = Color.FromArgb(200, 200, 200);
        ...
        public Color StatsCardValueForeColor { get; set; } = Color.FromArgb(255, 193, 7);
        public Color StatsCardValueBackColor { get; set; } = Color.FromArgb(44, 48, 52);
        public Color StatsCardValueBorderColor { get; set; } = Color.FromArgb(108, 117, 125);
        public Color StatsCardValueHoverForeColor { get; set; } = Color.White;
        public Color StatsCardValueHoverBackColor { get; set; } = Color.FromArgb(52, 58, 64);
        public Color StatsCardValueHoverBorderColor { get; set; } = Color.FromArgb(255, 193, 7);
        ...
        public Color StatsCardInfoForeColor { get; set; } = Color.FromArgb(200, 200, 200);
        public Color StatsCardInfoBackColor { get; set; } = Color.Transparent;
        public Color StatsCardInfoBorderColor { get; set; } = Color.FromArgb(108, 117, 125);
        ...
        public Color StatsCardTrendForeColor { get; set; } = Color.FromArgb(75, 192, 192);
        public Color StatsCardTrendBackColor { get; set; } = Color.FromArgb(44, 48, 52);
        public Color StatsCardTrendBorderColor { get; set; } = Color.FromArgb(108, 117, 125);
