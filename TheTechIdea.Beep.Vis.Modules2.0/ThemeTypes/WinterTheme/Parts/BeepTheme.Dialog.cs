...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class WinterTheme
    {
        ...
        public Color DialogBackColor { get; set; } = Color.FromArgb(230, 240, 250);
        public Color DialogForeColor { get; set; } = Color.FromArgb(27, 62, 92);
        ...
        public Color DialogYesButtonBackColor { get; set; } = Color.FromArgb(77, 182, 172);
        public Color DialogYesButtonForeColor { get; set; } = Color.White;
        public Color DialogYesButtonHoverBackColor { get; set; } = Color.FromArgb(97, 202, 192);
        public Color DialogYesButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogYesButtonHoverBorderColor { get; set; } = Color.FromArgb(120, 169, 255);
        public Color DialogCancelButtonBackColor { get; set; } = Color.FromArgb(45, 85, 120);
        public Color DialogCancelButtonForeColor { get; set; } = Color.White;
        public Color DialogCancelButtonHoverBackColor { get; set; } = Color.FromArgb(60, 100, 140);
        public Color DialogCancelButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogCancelButtonHoverBorderColor { get; set; } = Color.FromArgb(100, 149, 237);
        public Color DialogCloseButtonBackColor { get; set; } = Color.FromArgb(255, 99, 99);
        public Color DialogCloseButtonForeColor { get; set; } = Color.White;
        public Color DialogCloseButtonHoverBackColor { get; set; } = Color.FromArgb(255, 119, 119);
        public Color DialogCloseButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogCloseButtonHoverBorderColor { get; set; } = Color.FromArgb(200, 50, 50);
        public Color DialogHelpButtonBackColor { get; set; } = Color.FromArgb(100, 149, 237);
        public Color DialogNoButtonBackColor { get; set; } = Color.FromArgb(45, 85, 120);
        public Color DialogNoButtonForeColor { get; set; } = Color.White;
        public Color DialogNoButtonHoverBackColor { get; set; } = Color.FromArgb(60, 100, 140);
        public Color DialogNoButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogNoButtonHoverBorderColor { get; set; } = Color.FromArgb(100, 149, 237);
        public Color DialogOkButtonBackColor { get; set; } = Color.FromArgb(77, 182, 172);
        public Color DialogOkButtonForeColor { get; set; } = Color.White;
        public Color DialogOkButtonHoverBackColor { get; set; } = Color.FromArgb(97, 202, 192);
        public Color DialogOkButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogOkButtonHoverBorderColor { get; set; } = Color.FromArgb(120, 169, 255);
        ...
        public Color DialogErrorButtonBackColor { get; set; } = Color.FromArgb(255, 99, 99);
        public Color DialogErrorButtonForeColor { get; set; } = Color.White;
        public Color DialogErrorButtonHoverBackColor { get; set; } = Color.FromArgb(255, 119, 119);
        public Color DialogErrorButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogErrorButtonHoverBorderColor { get; set; } = Color.FromArgb(200, 50, 50);
        public Color DialogInformationButtonBackColor { get; set; } = Color.FromArgb(100, 149, 237);
        public Color DialogInformationButtonForeColor { get; set; } = Color.White;
        public Color DialogInformationButtonHoverBackColor { get; set; } = Color.FromArgb(120, 169, 255);
        public Color DialogInformationButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogInformationButtonHoverBorderColor { get; set; } = Color.FromArgb(80, 120, 160);
        public Color DialogQuestionButtonBackColor { get; set; } = Color.FromArgb(100, 149, 237);
        public Color DialogQuestionButtonForeColor { get; set; } = Color.White;
        public Color DialogQuestionButtonHoverBackColor { get; set; } = Color.FromArgb(120, 169, 255);
        public Color DialogQuestionButtonHoverForeColor { get; set; } = Color.White;
        public Color DialogQuestionButtonHoverBorderColor { get; set; } = Color.FromArgb(80, 120, 160);
    }
}