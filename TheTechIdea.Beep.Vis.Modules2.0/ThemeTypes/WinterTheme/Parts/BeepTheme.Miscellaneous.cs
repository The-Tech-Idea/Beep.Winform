...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class WinterTheme
    {
        ...
        public Color PrimaryTextColor { get; set; } = Color.FromArgb(27, 62, 92);
        public Color SecondaryTextColor { get; set; } = Color.FromArgb(200, 220, 240);
        public Color AccentTextColor { get; set; } = Color.FromArgb(100, 149, 237);
        ...
        public Color FocusIndicatorColor { get; set; } = Color.FromArgb(100, 149, 237);
