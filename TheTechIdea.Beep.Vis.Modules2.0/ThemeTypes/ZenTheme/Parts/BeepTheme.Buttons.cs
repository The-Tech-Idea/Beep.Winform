...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class ZenTheme
    {
        ...
        public Color ButtonBackColor { get; set; } = Color.FromArgb(64, 64, 64);
        public Color ButtonForeColor { get; set; } = Color.White;
        public Color ButtonBorderColor { get; set; } = Color.FromArgb(50, 50, 50);
        ...
        public Color ButtonPressedBackColor { get; set; } = Color.FromArgb(48, 48, 48);
        public Color ButtonPressedForeColor { get; set; } = Color.White;
        public Color ButtonPressedBorderColor { get; set; } = Color.FromArgb(40, 40, 40);
    }
}