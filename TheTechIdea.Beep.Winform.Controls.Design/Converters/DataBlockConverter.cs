...
namespace TheTechIdea.Beep.Winform.Controls.Converters
{
    ...
    {
        private Dictionary<string, IBeepDataBlock> _blockMap = new();
        public override bool GetStandardValuesExclusive(ITypeDescriptorContext context) => true;
        public override bool GetStandardValuesSupported(ITypeDescriptorContext context) => true;
        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType)
        {
            if (sourceType == typeof(string) || sourceType == typeof(IBeepDataBlock))
            {
                return true;
            }
        ...
        {
            if (context?.Container == null || context.Instance is not IBeepDataBlock currentBlock)
     ...
     object value)
        {
            ...
            if (value is IBeepDataBlock blockValue)
                return blockValue;
        ...
        {
            if (destinationType == typeof(string) && value is IBeepDataBlock block)
            {
