...
namespace TheTechIdea.Beep.Winform.Controls.AccordionMenus
{
    ...
    public class BeepAccordionMenuItem : BaseControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            {
                Width = AccordionStyleHelpers.GetRecommendedHighlightWidth(AccordionStyle.Material3),
                Height = itemHeight,
                Dock = DockStyle.Left,
                BackColor = AccordionThemeHelpers.GetAccordionBackgroundColor(
                    _currentTheme,
            ...
            {
                buttonRowPanel.BackColor = AccordionThemeHelpers.GetItemBackgroundColor(
                    _currentTheme,
                    UseThemeColors,
                    isHovered: true);
                highlightPanel.BackColor = AccordionThemeHelpers.GetHighlightColor(
                    _currentTheme,
                    UseThemeColors,
                    isHovered: true);
            };
            mainButton.MouseLeave += (s, e) =>
            {
                buttonRowPanel.BackColor = AccordionThemeHelpers.GetItemBackgroundColor(
                    _currentTheme,
                    UseThemeColors);
                highlightPanel.BackColor = AccordionThemeHelpers.GetAccordionBackgroundColor(
                    _currentTheme,
                    UseThemeColors);
            };
        ...
        public override void ApplyTheme()
        {
            ...
            if (_currentTheme != null)
            {
                ...
                highlightPanel.BackColor = AccordionThemeHelpers.GetAccordionBackgroundColor(
                    _currentTheme,
                    UseThemeColors);
                spacingPanel.BackColor = AccordionThemeHelpers.GetAccordionBackgroundColor(
                    _currentTheme,
                    UseThemeColors);
                ...
                foreach (Control ctrl in buttonRowPanel.Controls)
                {
                    ...
                    {
                        panel.BackColor = AccordionThemeHelpers.GetAccordionBackgroundColor(
                            _currentTheme,
                            UseThemeColors);
                    }
                }
                ...
                if (toggleButton != null)
                {
                    toggleButton.BackColor = AccordionThemeHelpers.GetItemBackgroundColor(
                        _currentTheme,
                        UseThemeColors);
                    toggleButton.ForeColor = AccordionThemeHelpers.GetItemForegroundColor(
                        _currentTheme,
                        UseThemeColors);
