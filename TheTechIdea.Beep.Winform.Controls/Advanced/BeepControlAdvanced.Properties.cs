    ...
    public partial class BeepControlAdvanced
    {
        ...
        public override string Text
        {
            ...
            set
            {
                ...
                if (value != null && value == "BeepControlAdvanced")
                {
                    value = "";
                }
        ...
        // Badge
        [Browsable(true)] public string BadgeText { get => _paint.BadgeText; set { _paint.BadgeText = value; UpdateControlRegion(); Invalidate(); } }
        [Browsable(true)] public Color BadgeBackColor { get => _paint.BadgeBackColor; set { _paint.BadgeBackColor = value; Invalidate(); } }
        [Browsable(true)] public Color BadgeForeColor { get => _paint.BadgeForeColor; set { _paint.BadgeForeColor = value; Invalidate(); } }
        [Browsable(true)] public Font BadgeFont { get => _paint.BadgeFont; set { _paint.BadgeFont = value; Invalidate(); } }
        [Browsable(true)] public BadgeShape BadgeShape { get => _paint.BadgeShape; set { _paint.BadgeShape = value; Invalidate(); } }
        ...
        [Browsable(true)] public TheTechIdea.Beep.Winform.Controls.Advanced.Helpers.ImageScaleMode ScaleMode { get; set; } = TheTechIdea.Beep.Winform.Controls.Advanced.Helpers.ImageScaleMode.KeepAspectRatio;
