    ...
    public partial class BeepBindingNavigator : BeepControl
    {
        ...
        private ToolTip SetupToolTip(ToolTip tooltip, Control control, string text)
        {
            if (tooltip == null)
            {
                tooltip = new ToolTip
                {
                    BackColor = TheTechIdea.Beep.Winform.Controls.Helpers.ColorUtils.MapSystemColor(SystemColors.Info),
                    ForeColor = TheTechIdea.Beep.Winform.Controls.Helpers.ColorUtils.MapSystemColor(SystemColors.InfoText)
                };
            }
