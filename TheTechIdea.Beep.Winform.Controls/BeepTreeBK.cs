...
namespace TheTechIdea.Beep.Winform.Controls
{
    ...
    public class BeepTreeBK : BeepControl
    {
        ...
        private Dictionary<int, BufferedPanel> _nodePanels = new Dictionary<int, BufferedPanel>();
        ...
        public void ExpandAll()
        {
            foreach (var panel in _nodePanels)
            {
                ...
                BufferedPanel panel1 = panel.Value;
                if (node != null)
                {
        ...
        public void RearrangeTree()
        {
            ...
            foreach (var node in _beeptreeRootnodes)
            {
              ...
              //  panel.Width = node.Width; // Match tree width
        ...
        private BufferedPanel AddRootNode(BeepTreeNode node)
        {
