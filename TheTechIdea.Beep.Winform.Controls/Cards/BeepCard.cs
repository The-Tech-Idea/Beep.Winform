...
namespace TheTechIdea.Beep.Winform.Controls
{
    ...
    public partial class BeepCard : BaseControl
    {
        ...
        // InitializePainter removed with the 56 painters it selected between. What style a card is
        // now decides which parts Compose() adds, from the table in CardStyleLayouts.
