...
{
    public class iOSContextMenuPainter : IContextMenuPainter
    {
        public FormStyle Style => FormStyle.iOS;
        ...
        public int GetPreferredItemHeight() => 44;
            ...
            ContextMenuMetrics metrics, IBeepTheme theme)
        {
            using (var path = GetRoundedRect(bounds, metrics.BorderRadius))
            {
                ...
                var innerRect = new Rectangle(bounds.X, bounds.Y, bounds.Width, bounds.Height / 4);
                using (var gradBrush = new LinearGradientBrush(innerRect,
            ...
            bool isSelected, bool isHovered, ContextMenuMetrics metrics, IBeepTheme theme)
        {
            ...
            if (owner.ShowCheckBox && item.IsCheckable)
            {
                ...
                DrawiOSCheckbox(g, checkRect, item.IsChecked, !item.IsEnabled, metrics);
            ...
            {
                DrawiOSChevron(g, itemRect, !item.IsEnabled, metrics, textColor);
            }
        }
        ...
        private void DrawiOSCheckbox(Graphics g, Rectangle rect, bool isChecked, bool isDisabled, ContextMenuMetrics metrics)
        {
        ...
        private void DrawiOSChevron(Graphics g, Rectangle itemRect, bool isDisabled, 
            ContextMenuMetrics metrics, Color arrowColor)
        {
            ...
            using (var pen = new Pen(arrowColor, 2f))
            {
                ...
                g.DrawLine(pen, chevronRect.X + 6, midY - 5, chevronRect.Right - 6, midY);
                g.DrawLine(pen, chevronRect.Right - 6, midY, chevronRect.X + 6, midY + 5);
            }
        }
