    ...
    public partial class BeepbindingNavigator : uc_Addin
    {
       ...
       // ImportDataManager importDataManager;
        ...
        private void MessegepictureBox_Click(object sender, EventArgs e)
        {
            try
            {
                //  if (MessageBox.Show(this.ParentNode, "Are you sure you want to cancel Changes?", "Beep", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == BeepDialogResult.OK)
                //  {
