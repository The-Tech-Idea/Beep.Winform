...
namespace TheTechIdea.Beep.Winform.Controls.Docking
{
    ...
    public partial class BeepDockspace : Panel
    {
       ...
       /// cursor hovers over it. Mirrors <c>DockPanelExt.ShowHint</c> from DockPanelSuite.
        ...
        /// <summary>
        /// Applies the current Beep theme to the dockspace header and tabs - the same entry point every
        /// <c>BaseControl</c>-derived control exposes.
        /// </summary>
        /// <remarks>
        /// BeepDockspace does not derive from <c>BaseControl</c>, so it does not inherit
