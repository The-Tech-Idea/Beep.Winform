...
namespace TheTechIdea.Beep.Winform.Controls.Docking.Models
{
    ...
    public partial class DockPanel : Panel
    {
        ...
        /// <summary>
        /// Applies the current Beep theme to the panel caption and body - the same entry point every
        /// <c>BaseControl</c>-derived control exposes.
        /// </summary>
        /// <remarks>
        /// DockPanel does not derive from <c>BaseControl</c>, so it does not inherit
