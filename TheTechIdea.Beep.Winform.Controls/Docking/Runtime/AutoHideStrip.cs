...
namespace TheTechIdea.Beep.Winform.Controls.Docking.Runtime
{
    ...
    public class AutoHideStrip : Control
    {
        ...
        /// <summary>
        /// Applies the current Beep theme to the auto-hide strip - the same entry point every
        /// <c>BaseControl</c>-derived control exposes.
        /// </summary>
        /// <remarks>
        /// AutoHideStrip does not derive from <c>BaseControl</c>, so it does not inherit
