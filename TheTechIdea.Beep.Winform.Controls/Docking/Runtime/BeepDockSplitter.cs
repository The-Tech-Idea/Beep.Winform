...
namespace TheTechIdea.Beep.Winform.Controls.Docking.Runtime
{
    ...
    public class BeepDockSplitter : Control
    {
        ...
        /// <summary>
        /// Applies the current Beep theme to the splitter bar - the same entry point every
        /// <c>BaseControl</c>-derived control exposes.
        /// </summary>
        /// <remarks>
        /// BeepDockSplitter does not derive from <c>BaseControl</c>, so it does not inherit
