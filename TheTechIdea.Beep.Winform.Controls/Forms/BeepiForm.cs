...
namespace TheTechIdea.Beep.Winform.Controls
{
    ...
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)] public BeepFormStylePresets StylePresets { get; } = new();
        ...
        [Category("Beep Caption")][DefaultValue(true)] public bool ShowCaptionBar { get => _captionHelper?.ShowCaptionBar ?? _legacyShowCaptionBar; set { if (_captionHelper != null) _captionHelper.ShowCaptionBar = value; _legacyShowCaptionBar = value; Invalidate(); } }
        [Category("Beep Caption")][DefaultValue(36)] public int CaptionHeight { get => _captionHelper?.CaptionHeight ?? _legacyCaptionHeight; set { if (value < 24) value = 24; if (_captionHelper != null) _captionHelper.CaptionHeight = value; _legacyCaptionHeight = value; Invalidate(); } }
