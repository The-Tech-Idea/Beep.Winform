...
namespace TheTechIdea.Beep.Winform.Controls.Forms.ModernForm.Painters
{
    ...
    internal sealed class CartoonFormPainter : IFormPainter, IFormPainterMetricsProvider, IFormNonClientPainter
    {
        ...
        private void PaintCartoonButtons(Graphics g, BeepiFormPro owner, Rectangle captionRect, FormPainterMetrics metrics)
        {
            ...
            PaintCartoonButton(g, closeRect, Color.FromArgb(255, 99, 71), FormHitAreaNames.Close, closeHovered);
            
            // Maximize button: Green/Blue
            PaintCartoonButton(g, maxRect, Color.FromArgb(50, 205, 50), FormHitAreaNames.Maximize, maxHovered);
            
            // Minimize button: Blue/Yellow
            PaintCartoonButton(g, minRect, Color.FromArgb(30, 144, 255), FormHitAreaNames.Minimize, minHovered);
            
            // Theme/Style buttons
            if (owner.ShowStyleButton)
            {
                PaintCartoonButton(g, owner.CurrentLayout.StyleButtonRect, Color.FromArgb(255, 105, 180), FormHitAreaNames.Style, styleHovered);
            }
            
            if (owner.ShowThemeButton)
            {
                PaintCartoonButton(g, owner.CurrentLayout.ThemeButtonRect, Color.FromArgb(255, 165, 0), FormHitAreaNames.Theme, themeHovered);
            }
        }
            ...
            using (var iconPen = new Pen(Color.Black, 2.5f))
            {
                ...
                switch (type)
                {
                    ...
                    case FormHitAreaNames.Minimize:
                        ...
                        break;
                    case FormHitAreaNames.Style: // Paintbrush-ish line
                         g.DrawLine(iconPen, cx - iconSize/2, cy + iconSize/2, cx + iconSize/2, cy - iconSize/2);
                        break;
                    case FormHitAreaNames.Theme: // Layers / Circle
