    ...
    public class CustomFormPainter : IFormPainter, IFormPainterMetricsProvider, IFormNonClientPainter
    {
        ...
        private void PaintConfigurableButtons(Graphics g, BeepiFormPro owner, Rectangle captionRect, FormPainterMetrics metrics)
        {
            ...
            if (owner.ShowStyleButton)
            {
                ...
                PaintShapedButton(g, styleRect, Color.FromArgb(ButtonFillOpacity, 150, 120, 180), 
                    metrics.BorderColor, padding, buttonSize, FormHitAreaNames.Style, styleHovered);
            }
            ...
            if (owner.ShowThemeButton)
            {
                ...
                PaintShapedButton(g, themeRect, Color.FromArgb(ButtonFillOpacity, 200, 150, 100), 
                    metrics.BorderColor, padding, buttonSize, FormHitAreaNames.Theme, themeHovered);
            }
        }
        ...
        private void PaintShapedButton(Graphics g, Rectangle buttonRect, Color baseColor, Color borderColor, int padding, int size, string buttonType, bool isHovered = false)
        {
            ...
            using (var shapePath = CreateButtonShapePath(centerX, centerY, size))
            {
                ...
                {
                    var lightColor = ShiftLuminance(baseColor, 0.25f);
                ...
                Color currentBorderColor = isHovered ? ShiftLuminance(borderColor, 0.3f) : Color.FromArgb(180, borderColor);
