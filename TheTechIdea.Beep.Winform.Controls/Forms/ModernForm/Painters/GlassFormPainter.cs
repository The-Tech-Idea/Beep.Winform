...
namespace TheTechIdea.Beep.Winform.Controls.Forms.ModernForm.Painters
{
    ...
    internal sealed class GlassFormPainter : IFormPainter, IFormPainterMetricsProvider, IFormNonClientPainter
    {
        ...
        private void PaintGlassRefractionButtons(Graphics g, BeepiFormPro owner, Rectangle captionRect, FormPainterMetrics metrics)
        {
            ...
            PaintGlassButton(g, closeRect, Color.FromArgb(232, 17, 35), padding, buttonSize, FormHitAreaNames.Close, closeHovered);
            ...
            PaintGlassButton(g, maxRect, Color.FromArgb(16, 124, 16), padding, buttonSize, FormHitAreaNames.Maximize, maxHovered);
            ...
            PaintGlassButton(g, minRect, Color.FromArgb(0, 120, 215), padding, buttonSize, FormHitAreaNames.Minimize, minHovered);
            ...
            if (owner.ShowStyleButton)
            {
                ...
                PaintGlassButton(g, styleRect, Color.FromArgb(135, 100, 184), padding, buttonSize, FormHitAreaNames.Style, styleHovered);
            }
            ...
            if (owner.ShowThemeButton)
            {
                ...
                PaintGlassButton(g, themeRect, Color.FromArgb(247, 99, 12), padding, buttonSize, FormHitAreaNames.Theme, themeHovered);
            }
        }
        ...
        public void CalculateLayoutAndHitAreas(BeepiFormPro owner)
        {
            ...
            var buttonSize = new Size(metrics.ButtonWidth, captionHeight);
            var buttonY = 0;
