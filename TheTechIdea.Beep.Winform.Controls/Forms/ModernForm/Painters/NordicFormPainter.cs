...
namespace TheTechIdea.Beep.Winform.Controls.Forms.ModernForm.Painters
{
    ...
    internal sealed class NordicFormPainter : IFormPainter, IFormPainterMetricsProvider, IFormNonClientPainter
    {
        ...
        {
            return FormPainterMetrics.DefaultForCached(FormStyle.Nordic, owner.UseThemeColors ? owner.CurrentTheme : null);
        }
        ...
        public void PaintBackground(Graphics g, BeepiFormPro owner)
        {
            ...
            var lightColor = ShiftLuminance(metrics.BackgroundColor, 0.05f);
        ...
        private void PaintRuneButton(Graphics g, Rectangle buttonRect, Color baseColor, int padding, int size, string buttonType, bool isHovered)
        {
            ...
            Color effectiveColor = isHovered ? ShiftLuminance(baseColor, 0.15f) : baseColor;
            ...
            using (var path = CreateRoundedRectanglePath(rect, new CornerRadius(3)))
            {
                ...
                using (var gradientBrush = new LinearGradientBrush(rect,
                    ShiftLuminance(effectiveColor, 0.08f),
                    ShiftLuminance(effectiveColor, -0.05f),
                    LinearGradientMode.Vertical))
                {
                ...
                using (var borderPen = new Pen(ShiftLuminance(effectiveColor, -0.15f), borderWidth))
                {
