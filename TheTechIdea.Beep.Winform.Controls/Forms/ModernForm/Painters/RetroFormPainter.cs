...
namespace TheTechIdea.Beep.Winform.Controls.Forms.ModernForm.Painters
{
    ...
    internal sealed class RetroFormPainter : IFormPainter, IFormPainterMetricsProvider, IFormNonClientPainter
    {
        ...
        {
            return FormPainterMetrics.DefaultForCached(FormStyle.Retro, owner.UseThemeColors ? owner.CurrentTheme : null);
        }
        ...
        public void PaintCaption(Graphics g, BeepiFormPro owner, Rectangle captionRect)
        {
            ...
            var lightEdge = ShiftLuminance(metrics.CaptionColor, 0.25f);
            var darkEdge = ShiftLuminance(metrics.CaptionColor, -0.25f);
        ...
        private void PaintRetroButtons(Graphics g, BeepiFormPro owner, Rectangle captionRect, FormPainterMetrics metrics)
        {
            ...
            // Close button: X
            PaintRetroButton(g, closeRect, retroGray, FormHitAreaNames.Close, closeHovered);
            
            // Maximize button: Square
            PaintRetroButton(g, maxRect, retroGray, FormHitAreaNames.Maximize, maxHovered);
            
            // Minimize button: Underline
            PaintRetroButton(g, minRect, retroGray, FormHitAreaNames.Minimize, minHovered);
            
            // Theme/Style buttons if shown
            if (owner.ShowStyleButton)
            {
                var styleRect = owner.CurrentLayout.StyleButtonRect;
                PaintRetroButton(g, styleRect, retroGray, FormHitAreaNames.Style, styleHovered);
            }
            
            if (owner.ShowThemeButton)
            {
                var themeRect = owner.CurrentLayout.ThemeButtonRect;
                PaintRetroButton(g, themeRect, retroGray, FormHitAreaNames.Theme, themeHovered);
            }
        }
