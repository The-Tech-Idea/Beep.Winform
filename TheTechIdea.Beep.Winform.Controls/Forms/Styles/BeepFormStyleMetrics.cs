namespace TheTechIdea.Beep.Winform.Controls
{
    ...
    internal static class BeepFormStyleMetricsDefaults
    {
        public static readonly Dictionary<BeepFormStyle, BeepFormStyleMetrics> Map = new()
        {
            ...
            [BeepFormStyle.Material] = new BeepFormStyleMetrics{ BorderRadius=4, BorderThickness=0, ShadowDepth=5, EnableGlow=true, GlowSpread=15, CaptionHeight=36, RibbonHeight=72, CaptionButtonSize=26 },
