...
namespace TheTechIdea.Beep.Winform.Controls.Helpers //AllocationRequest
{    
    ...
    class LogManager
    {
        ...
        public void Log(Categories category, String msg)
        {
            ...
            // log it
            writer.Write(caller, category, msg, BasePath, LogNameHeader);
    ...
    class LogWriter
    {
        ...
        /// <returns></returns>
        /// 
        public LogWriter(IDMEEditor  dMEEditor)
        {
            DME = dMEEditor;
        }
        ...
        /// <param name="name"></param>
        public  void Write(String from, LogManager.Categories category, String msg, String path, String name)
        {
