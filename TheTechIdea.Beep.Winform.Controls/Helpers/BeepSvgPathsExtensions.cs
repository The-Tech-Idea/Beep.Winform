...
namespace TheTechIdea.Beep.Winform.Controls.Helpers
{
    public static class BeepSvgPathsExtensions
    {
        ...
        /// <param name="svgResourcePath">The SVG resource path from BeepSvgPaths</param>
        ...
        public static void LoadSvgFromEmbeddedResource(this BeepImage beepImage, string svgResourcePath)
        {
            ...
            try
            {
                var (isSvg, result) = ImageLoader.LoadFromEmbeddedResource(svgResourcePath, BeepSvgPaths.ResourceAssembly);
