...
namespace TheTechIdea.Beep.Winform.Controls
{
    ...
    public partial class BeepListBox
    {
        ...
        private void HandleItemClick(SimpleItem item, MouseEventArgs e, Rectangle itemRect)
        {
            ...
            if (SelectionMode == SelectionModeEnum.MultiSimple || SelectionMode == SelectionModeEnum.MultiExtended)
            {
                var visibleItems = _helper.GetVisibleItems();
                if (SelectionMode == SelectionModeEnum.MultiExtended && shift && _anchorItem != null && _listItems.Count > 0)
                {
                ...
                {
                    if (SelectionMode == SelectionModeEnum.MultiSimple)
                    {
...
//            if (SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiSimple || SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiExtended)
//            {
//                if (SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiExtended && shift && _anchorItem != null && _listItems.Count > 0)
//                {
//                    var visibleItems = _helper.GetVisibleItems();
//                    int targetIndex = visibleItems.IndexOf(item);
//                    if (targetIndex >= 0)
...
//                else
//                {
//                    if (SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiSimple)
//                    {
//                        // Toggle selection on click (MultiSimple)
//                        ToggleSelection(item);
//                        SelectedItem = item; // focus
...
//                    }
//                    // Space toggles selection membership if MultiSelect mode is active and there is a selected item
//                    if ((SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiSimple || SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiExtended) && _selectedItem != null)
//                    {
//                        ToggleSelection(_selectedItem);
//                        e.Handled = true;
//                    }
...
//                    case Keys.A:
//                        if ((Control.ModifierKeys & Keys.Control) == Keys.Control && (SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiExtended || SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiSimple))
//                        {
//                            SelectAll();
//                            e.Handled = true;
//                        }
...
//                    if (shift)
//                    {
//                        if (SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiExtended)
//                        {
...
//                for (int i = start; i <= end; i++) SetItemCheckbox(visibleItems[i], true);
//            }
//            if (SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiSimple || SelectionModeEnum == BeepListBox.SelectionModeEnum.MultiExtended || MultiSelect)
//            {
//                for (int i = start; i <= end; i++) if (!_selectedItems.Contains(visibleItems[i])) _selectedItems.Add(visibleItems[i]);
//            }
//            _anchorItem = visibleItems[end];
