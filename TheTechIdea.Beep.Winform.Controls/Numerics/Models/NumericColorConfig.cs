...
{
    /// <summary>
    /// Color configuration model for numeric control
    /// Stores all color properties for theme and customization
    /// </summary>
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class NumericColorConfig
    {
        [Category("Colors")]
        ...
        [Category("Colors")]
        [Description("Background color (focused)")]
        public Color FocusedBackgroundColor { get; set; } = Color.FromArgb(255, 255, 255);
        ...
        [Category("Colors")]
        [Description("Text color (hovered)")]
        public Color HoverTextColor { get; set; } = Color.FromArgb(33, 33, 33);

        [Category("Colors")]
        [Description("Text color (focused)")]
        public Color FocusedTextColor { get; set; } = Color.FromArgb(33, 33, 33);
        ...
        public override string ToString() => $"BG: {BackgroundColor}, Text: {TextColor}, Border: {BorderColor}";
    }
}
