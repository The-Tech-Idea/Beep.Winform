...
{
    /// <summary>
    /// Renders rating using flag / bookmark shapes.
    /// Each symbol looks like a downward-pointing pennant / bookmark.
    /// </summary>
    public class FlagRatingPainter : RatingPainterBase
    {
        ...
        public override void Paint(RatingPainterContext ctx)
        {
            ...
            int topY    = bounds.Top  + (bounds.Height - size)  / 2;
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                bool filled  = (i < ctx.SelectedRating);
                ...
                // Bookmark shape: rectangle with V-notch at the bottom
                float mid  = x + w / 2f;
                float notch = h * 0.25f;
