...
namespace TheTechIdea.Beep.Winform.Controls.Tooltips
{
    public sealed class RibbonSuperTooltip : IDisposable
    {
        ...
        private void ToolTip_Draw(object? sender, DrawToolTipEventArgs e)
        {
            ...
            Color contrastText = Helpers.ColorUtils.GetForColor(_theme.TabActiveBack, _theme.Text);
            using var titleBrush = new SolidBrush(contrastText);
            using var bodyBrush = new SolidBrush(contrastText);
            using var footBrush = new SolidBrush(Helpers.ColorUtils.ShiftLuminance(contrastText, -.25f));
        ...
        {
            using var borderPen = new Pen(ShiftLuminance(_theme.GroupBorder, .1f));
            using var backBrush = new SolidBrush(ShiftLuminance(_theme.GroupBack, .04f));
        ...
        {
            return Helpers.ColorUtils.ShiftLuminance(color, amount);
        }
