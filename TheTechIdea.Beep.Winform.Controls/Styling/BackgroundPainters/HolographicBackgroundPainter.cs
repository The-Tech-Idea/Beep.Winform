...
namespace TheTechIdea.Beep.Winform.Controls.Styling.BackgroundPainters
{
    public static class HolographicBackgroundPainter
    {
            ...
            bool useThemeColors, ControlState state = ControlState.Normal)
        {
            ...
            Color baseColor = useThemeColors && theme != null ? theme.BackgroundColor : Color.FromArgb(24, 17, 47);
            ...
            // Gradient with custom ColorBlend - can't cache ColorBlend easily; get brush and then apply blend
            var gradient = PaintersFactory.GetLinearGradientBrush(bounds, Color.Magenta, Color.Cyan, LinearGradientMode.Horizontal);
            ...
            var shinePen = PaintersFactory.GetPen(Color.FromArgb(40, Color.White), 3f);
