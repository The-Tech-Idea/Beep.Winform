...
namespace TheTechIdea.Beep.Winform.Controls.Styling.BackgroundPainters
{
    public static class PaperBackgroundPainter
    {
            ...
            bool useThemeColors, ControlState state = ControlState.Normal)
        {
            ...
            Color baseColor = useThemeColors && theme != null ? theme.BackgroundColor : Color.FromArgb(0xFA,0xFA,0xF8);
            ...
            var noiseBrush = PaintersFactory.GetSolidBrush(Color.FromArgb(8,200,200,200));
            ...
            var pen = PaintersFactory.GetPen(Color.FromArgb(40, Color.White),1f);
