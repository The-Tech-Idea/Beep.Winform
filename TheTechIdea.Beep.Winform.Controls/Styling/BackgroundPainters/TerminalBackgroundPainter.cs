...
namespace TheTechIdea.Beep.Winform.Controls.Styling.BackgroundPainters
{
    public static class TerminalBackgroundPainter
    {
            ...
            bool useThemeColors, ControlState state = ControlState.Normal)
        {
            ...
            Color baseColor = useThemeColors ? theme.BackgroundColor : Color.Black;
            Color accent = useThemeColors ? theme.AccentColor : Color.FromArgb(0x00, 0xFF, 0x00);
            ...
            using (var gridPen = new Pen(Color.FromArgb(5, accent), 1))
            {
                int size = 20;
