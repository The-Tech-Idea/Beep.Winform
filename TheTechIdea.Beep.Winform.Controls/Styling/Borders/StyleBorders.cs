...
namespace TheTechIdea.Beep.Winform.Controls.Styling.Borders
{
    ...
    public static class StyleBorders
    {
        ...
        public static int GetRadius(BeepControlStyle style)
        {
            return style switch
            {
                BeepControlStyle.Material3 => 4,               // Material 3 extra-large
                BeepControlStyle.iOS15 => 4,                   // iOS gentle curve
                BeepControlStyle.Fluent2 => 4,                  // Fluent subtle
                BeepControlStyle.Minimal => 0,                  // No radius
                BeepControlStyle.AntDesign => 2,                // Ant subtle
                BeepControlStyle.MaterialYou => 4,             // Material You large
                ...
                BeepControlStyle.TailwindCard => 2,             // Tailwind rounded-lg
                BeepControlStyle.NotionMinimal => 3,            // Notion very subtle
                BeepControlStyle.VercelClean => 5,              // Vercel subtle
                BeepControlStyle.StripeDashboard => 2,          // Stripe comfortable
                BeepControlStyle.DarkGlow => 2,                // Dark rounded
                BeepControlStyle.DiscordStyle => 8,             // Discord rounded
                BeepControlStyle.GradientModern => 4,          // Modern very rounded
                BeepControlStyle.GlassAcrylic => 2,            // Glass rounded
                BeepControlStyle.Neumorphism => 4,             // Neo very rounded
                BeepControlStyle.Bootstrap => 4,                // Bootstrap subtle
                BeepControlStyle.FigmaCard => 6,                // Figma subtle
                BeepControlStyle.PillRail => 6,                // Pill very rounded
                ...
                BeepControlStyle.Cinnamon => 4,                 // Cinnamon rounded
