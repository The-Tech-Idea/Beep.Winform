...
{
    /// <summary>
    /// Minimal flat path painter
    /// Uses simple solid fills with minimal styling
    /// </summary>
    public static class MinimalPathPainter
    {
        ...
        {
            Color fillColor = PathPainterHelpers.GetColorFromStyleOrTheme(theme, useThemeColors, "Primary", Color.FromArgb(64, 64, 64));
