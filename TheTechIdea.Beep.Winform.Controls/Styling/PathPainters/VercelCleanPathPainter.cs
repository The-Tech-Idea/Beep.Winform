...
{
    /// <summary>
    /// Vercel clean monochrome path painter
    /// Uses stark black and white fills
    /// </summary>
    public static class VercelCleanPathPainter
    {
        ...
        {
            Color fillColor = PathPainterHelpers.GetColorFromStyleOrTheme(theme, useThemeColors, "Primary", Color.Black);
