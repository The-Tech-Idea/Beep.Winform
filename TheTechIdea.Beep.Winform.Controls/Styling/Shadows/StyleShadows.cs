    ...
    public static class StyleShadows
    {
        ...
        public static int GetShadowBlur(BeepControlStyle style)
        {
            return style switch
            {
                ...
                BeepControlStyle.TailwindCard => 10,            // Tailwind prominent
                BeepControlStyle.StripeDashboard => 12,         // Stripe generous
                BeepControlStyle.DarkGlow => 14,                // Glow large
                BeepControlStyle.GradientModern => 12,          // Modern soft
                BeepControlStyle.Neumorphism => 12,             // Neo soft large
                ...
                BeepControlStyle.Material => 10,                // Material soft
                BeepControlStyle.WebFramework => 8,             // Web standard
                BeepControlStyle.Effect => 12,                  // Effect dramatic
                BeepControlStyle.Office => 8,                   // Office subtle
                BeepControlStyle.Gnome => 6,                    // Gnome very subtle
                BeepControlStyle.Kde => 8,                      // KDE soft glow
                BeepControlStyle.Cinnamon => 8,                 // Cinnamon moderate
                BeepControlStyle.Elementary => 8,               // Elementary subtle
                BeepControlStyle.NeoBrutalist => 0,             // Neo-Brutalist no blur (hard edge)
                BeepControlStyle.Gaming => 12,                  // Gaming dramatic glow
                BeepControlStyle.Neon => 8,                     // Neon large glow
                BeepControlStyle.ArcLinux => 6,
                BeepControlStyle.Brutalist => 6,
                BeepControlStyle.Cartoon => 10,
                BeepControlStyle.ChatBubble => 8,
                BeepControlStyle.Cyberpunk => 14,
                BeepControlStyle.Dracula => 10,
                BeepControlStyle.Glassmorphism => 10,
        ...
        public static int GetShadowSpread(BeepControlStyle style)
        {
            return style switch
            {
                ...
                BeepControlStyle.Neon => 2,                     // Neon glow expands
                _ => 0
            };
        }
