...
{
    /// <summary>
    /// Bootstrap button painter - Bootstrap primary blue #0D6EFD with 4px radius
    /// Supports: Normal, Hovered, Pressed, Selected, Disabled, Focused states
    /// </summary>
    public static class BootstrapButtonPainter
    {
        ...
        {
            // Bootstrap: Classic Bootstrap primary blue
            Color bootstrapBlue = Color.FromArgb(13, 110, 253);
            Color upColor = SpinnerButtonPainterHelpers.ApplyState(bootstrapBlue, upState);
            Color downColor = SpinnerButtonPainterHelpers.ApplyState(bootstrapBlue, downState);
