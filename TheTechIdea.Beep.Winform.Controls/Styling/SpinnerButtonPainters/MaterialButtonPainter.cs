...
{
    /// <summary>
    /// Button painter for Material Design styles (Material3, MaterialYou)
    /// Uses filled buttons with high radius
    /// Legacy painter - now supports state
    /// </summary>
    public static class MaterialButtonPainter
    {
            ...
            ControlState downState = ControlState.Normal)
        {
            ...
            // Material uses filled buttons with 28px radius
            int radius = 28;
