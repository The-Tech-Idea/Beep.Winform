...
{
    /// <summary>
    /// Minimal button painter - Clean simple outlined buttons with 4px radius
    /// Supports: Normal, Hovered, Pressed, Selected, Disabled, Focused states
    /// </summary>
    public static class MinimalButtonPainter
    {
            ...
            ControlState downState = ControlState.Normal)
        {
            ...
            Color arrowColor = useThemeColors ? theme.ForeColor : Color.FromArgb(60, 60, 60);
