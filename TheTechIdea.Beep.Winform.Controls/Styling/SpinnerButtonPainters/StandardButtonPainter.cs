...
{
    /// <summary>
    /// Standard button painter for most web framework styles
    /// Used by: Bootstrap, Tailwind, Discord, Stripe, Figma, AntDesign, Chakra, etc.
    /// Legacy painter - now supports state
    /// </summary>
    public static class StandardButtonPainter
    {
            ...
            SpinnerButtonPainterHelpers.ControlState downState = SpinnerButtonPainterHelpers.ControlState.Normal)
        {
            ...
            Color backgroundColor = GetColor(style, StyleColors.GetSecondary, "Secondary", theme, useThemeColors);
            Color arrowColor = GetColor(style, StyleColors.GetForeground, "Foreground", theme, useThemeColors);
            
            Color upBackgroundColor = SpinnerButtonPainterHelpers.ApplyState(backgroundColor, upState);
            Color downBackgroundColor = SpinnerButtonPainterHelpers.ApplyState(backgroundColor, downState);
