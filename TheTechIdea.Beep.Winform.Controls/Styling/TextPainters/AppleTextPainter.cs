...
{
    /// <summary>
    /// Text painter for Apple styles (iOS15, MacOSBigSur)
    /// Uses SF Pro font family with negative tracking
    /// </summary>
    public static class AppleTextPainter
    {
        public static void Paint(Graphics g, Rectangle bounds, string text, bool isFocused, BeepControlStyle style, IBeepTheme theme, bool useThemeColors)
        {
            ...
            using (var textBrush = new SolidBrush(textColor))
            {
                ...
                // Apple uses tighter tracking (negative letter spacing)
