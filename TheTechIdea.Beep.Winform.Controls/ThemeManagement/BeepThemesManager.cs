    ...
    public static class BeepThemesManager
    {
        ...
        public static string GetThemeNameForFormStyle(FormStyle newFormStyle)
        {
            return newFormStyle switch
            {
                ...
                FormStyle.Minimal => "MinimalTheme",
                FormStyle.MacOS => "MacOSTheme",
                FormStyle.Fluent => "FluentTheme",
                FormStyle.Material => "MaterialDesignTheme",
                FormStyle.Cartoon => "CartoonTheme",
                FormStyle.ChatBubble => "ChatBubbleTheme",
                FormStyle.Glass => "GlassTheme",
                FormStyle.Metro => "MetroTheme",
                FormStyle.Metro2 => "Metro2Theme",
                FormStyle.GNOME => "GNOMETheme",
                FormStyle.NeoMorphism => "NeoMorphismTheme",
                FormStyle.Glassmorphism => "GlassmorphismTheme",
                FormStyle.Brutalist => "BrutalistTheme",
                FormStyle.Retro => "RetroTheme",
                FormStyle.Cyberpunk => "CyberpunkTheme",
                FormStyle.Nordic => "NordicTheme",
                FormStyle.iOS => "iOSTheme",
                FormStyle.Ubuntu => "UbuntuTheme",
                FormStyle.KDE => "KDETheme",
                FormStyle.ArcLinux => "ArcLinuxTheme",
                FormStyle.Dracula => "DraculaTheme",
                FormStyle.Solarized => "SolarizedTheme",
                FormStyle.OneDark => "OneDarkTheme",
                FormStyle.GruvBox => "GruvBoxTheme",
                FormStyle.Nord => "NordTheme",
                FormStyle.Tokyo => "TokyoTheme",
                FormStyle.Paper => "PaperTheme",
                FormStyle.Neon => "NeonTheme",
                FormStyle.Holographic => "HolographicTheme",
