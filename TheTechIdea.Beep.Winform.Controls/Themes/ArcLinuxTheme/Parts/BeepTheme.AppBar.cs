...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class ArcLinuxTheme
    {
        private void ApplyAppBar()
        {
            ...
            this.AppBarTitleForeColor = OnBackgroundColor; // ensure contrast on dark caption
            this.AppBarTitleBackColor = BackgroundColor;
            this.AppBarSubTitleForeColor = ThemeUtil.Lighten(OnBackgroundColor, 0.12);
            ...
            this.AppBarSubTitleStyle = new TypographyStyle { FontFamily = "Noto Sans", FontSize = 12.5f, FontWeight = FontWeight.Normal, FontStyle = FontStyle.Regular, TextColor = AppBarSubTitleForeColor, LineHeight = 1.55f };
            this.AppBarTextStyle = new TypographyStyle { FontFamily = "Noto Sans", FontSize = 12.5f, FontWeight = FontWeight.Normal, FontStyle = FontStyle.Regular, TextColor = AppBarForeColor, LineHeight = 1.55f };
