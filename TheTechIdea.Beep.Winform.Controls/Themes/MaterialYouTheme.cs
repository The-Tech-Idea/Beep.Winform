...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    ...
    /// - Dynamic color system based on source color
    /// - Tonal color palette
    /// - Elevation-based surfaces
    /// - Material Design typography (Roboto)
    /// - Rounded corners & Material 3 look (pairs with MaterialYouFormPainter)
    /// </summary>
    public class MaterialYouTheme : IBeepTheme
    {
        // Identity
        public string ThemeName { get; } = "MaterialYouTheme";
        ...
        // Constructor
        public MaterialYouTheme()
        {
            // --- Base palette (Material You/Material 3)
            // Material 3 uses dynamic colors, but we'll use a default palette
            var background = C(255, 251, 235);      // Material 3 light surface
            var surface = C(255, 255, 255);        // Material 3 surface
            var foreground = C(28, 27, 31);         // Material 3 on-surface
            var border = C(121, 116, 126);          // Material 3 outline
            var primary = C(103, 80, 164);         // Material 3 primary (#6750A4)
            var secondary = C(121, 116, 126);       // Material 3 secondary
            var accent = primary;
            var muted = C(247, 243, 249);          // Material 3 surface variant
            var mutedForeground = C(121, 116, 126); // Material 3 on-surface variant
            
            // Theme color aliases (replacing terminal green colors with Material You colors)
            ...
            // Core palette (Material 3)
            PrimaryColor = primary;
            SecondaryColor = secondary;
            AccentColor = accent;
            BackgroundColor = background;
            SurfaceColor = surface;
            ErrorColor = C(186, 26, 26);            // Material 3 error (#BA1A1A)
            WarningColor = C(245, 124, 0);          // Material 3 warning
            SuccessColor = C(56, 142, 60);          // Material 3 success
            OnPrimaryColor = C(255, 255, 255);      // Material 3 on-primary
            ...
            DisabledBackColor = C(247, 243, 249);
            DisabledForeColor = C(121, 116, 126);
            DisabledBorderColor = C(230, 224, 233);
            BorderColor = border;
            ActiveBorderColor = primary;
            InactiveBorderColor = border;
            // --- AppBar / Caption (matches MaterialYouFormPainter)
            AppBarBackColor = surface;
            AppBarForeColor = foreground;
            AppBarButtonBackColor = C(247, 243, 249);  // Material 3 surface variant
            AppBarButtonForeColor = foreground;
            AppBarTextBoxBackColor = surface;
            ...
            // Material You control colors
            AppBarCloseButtonColor = ErrorColor;  // Material 3 error
            AppBarMaxButtonColor = SuccessColor;  // Material 3 success
            AppBarMinButtonColor = primary;       // Material 3 primary

            // Typography for AppBar (Roboto, Material 3)
            AppBarTitleStyle = TS(13, FontStyle.Bold, 600, foreground, mono: false);
            AppBarSubTitleStyle = TS(12, FontStyle.Regular, 400, mutedForeground, mono: false);
            AppBarTextStyle = TS(12, FontStyle.Regular, 400, foreground, mono: false);
            ...
            FontName = "Roboto";
            FontFamily = FontName;
            FontSize = 14f;  // Material 3 base size

            TitleStyle = TS(22, FontStyle.Bold, 700, foreground, mono: false);
            SubtitleStyle = TS(16, FontStyle.Regular, 600, mutedForeground, mono: false);
            BodyStyle = TS(12, FontStyle.Regular, 400, foreground, mono: false);
            CaptionStyle = TS(11, FontStyle.Regular, 400, mutedForeground, mono: false);
            ButtonStyle = TS(12, FontStyle.Bold, 600, C(255, 255, 255), mono: false);
            LinkStyle = TS(12, FontStyle.Regular, 500, accent, mono: false);
            LinkStyle.IsUnderlined = true; // Links should be underlined
            OverlineStyle = TS(10, FontStyle.Regular, 600, mutedForeground, mono: false);

            DisplayLarge = TS(48, FontStyle.Regular, 300, foreground, mono: false);
            DisplayMedium = TS(36, FontStyle.Regular, 300, foreground, mono: false);
            DisplaySmall = TS(28, FontStyle.Regular, 400, foreground, mono: false);
            HeadlineLarge = TS(24, FontStyle.Bold, 600, foreground, mono: false);
            HeadlineMedium = TS(22, FontStyle.Bold, 600, foreground, mono: false);
            HeadlineSmall = TS(20, FontStyle.Bold, 600, foreground, mono: false);
            TitleLarge = TS(18, FontStyle.Bold, 600, foreground, mono: false);
            TitleMedium = TS(16, FontStyle.Bold, 600, foreground, mono: false);
            TitleSmall = TS(14, FontStyle.Bold, 600, foreground, mono: false);
            BodyLarge = TS(14, FontStyle.Regular, 400, foreground, mono: false);
            BodyMedium = TS(12, FontStyle.Regular, 400, foreground, mono: false);
            BodySmall = TS(11, FontStyle.Regular, 400, mutedForeground, mono: false);
            LabelLarge = TS(13, FontStyle.Regular, 500, foreground, mono: false);
            LabelMedium = TS(12, FontStyle.Regular, 500, foreground, mono: false);
            LabelSmall = TS(11, FontStyle.Regular, 500, mutedForeground, mono: false);
            ...
            BorderSize = 0;      // Material 3 uses elevation, not borders

            IconSet = "Minimal";
            ApplyThemeToIcons = true;
            ShadowColor = C(0, 0, 0);
            ShadowOpacity = 0.3f; // Material 3 elevation shadows
            ...
            // --- Buttons
            // Material You: neutral default button, distinct from background/surface
            ButtonBackColor = C(236, 232, 240);
            ButtonForeColor = foreground;  // Theme text
            ButtonBorderColor = border;
            
            // Hover: darker neutral
            ButtonHoverBackColor = C(224, 219, 232);
            ButtonHoverForeColor = foreground;
            ButtonHoverBorderColor = primary;
            
            // Pressed: strongest neutral
            ButtonPressedBackColor = C(210, 204, 220);
            ButtonPressedForeColor = foreground;
            ButtonPressedBorderColor = primary;
            ...
            ButtonSelectedHoverBackColor = C(37, 99, 235);
            ...
            CheckBoxHoverBorderColor = accent;
            CheckBoxFont = BodyMedium;
            CheckBoxCheckedFont = BodyMedium;

            RadioButtonBackColor = surface;
            ...
            RadioButtonHoverBorderColor = accent;
            ...
            // --- TextBox
            TextBoxBackColor = surface;
            TextBoxForeColor = foreground;
            TextBoxBorderColor = border;
            TextBoxHoverBackColor = surface;
            TextBoxHoverForeColor = foreground;
            TextBoxHoverBorderColor = accent;
            TextBoxSelectedBackColor = surface;
            ...
            TextBoxErrorPlaceholderColor = C(239, 68, 68);
            ...
            // Validate and auto-fix contrast issues (Material 3 standard contrast)
