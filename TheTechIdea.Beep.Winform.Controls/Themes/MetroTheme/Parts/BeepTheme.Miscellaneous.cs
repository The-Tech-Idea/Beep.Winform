...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class MetroTheme
    {
        private void ApplyMiscellaneous()
        {
            ...
            this.SelectedRowBackColor = BackgroundColor;
            this.SelectedRowForeColor = ForeColor;
            this.SubLabelForColor = BackgroundColor;
            this.SubLabelBackColor = BackgroundColor;
            this.SubLabelHoverBackColor = BackgroundColor;
            this.SubLabelHoverForeColor = ForeColor;
            this.VisitedLinkColor = BackgroundColor;
            this.HoverLinkColor = BackgroundColor;
            ...
            this.ScrollBarThumbColor = BackgroundColor;
            this.ScrollBarTrackColor = BackgroundColor;
            this.ScrollBarHoverThumbColor = BackgroundColor;
            this.ScrollBarHoverTrackColor = BackgroundColor;
            this.ScrollBarActiveThumbColor = BackgroundColor;
            ...
            this.ScrollListItemHoverBackColor = BackgroundColor;
            this.ScrollListItemSelectedForeColor = ForeColor;
            this.ScrollListItemSelectedBackColor = BackgroundColor;
