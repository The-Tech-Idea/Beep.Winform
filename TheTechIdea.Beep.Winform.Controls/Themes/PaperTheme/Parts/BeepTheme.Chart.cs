...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class PaperTheme
    {
        private void ApplyChart()
        {
            ...
            this.ChartAxisColor = BackgroundColor;
            this.ChartTitleColor = BackgroundColor;
            ...
            this.ChartDefaultSeriesColors = new System.Collections.Generic.List<Color> { PrimaryColor, SecondaryColor, AccentColor, InactiveBorderColor };
        }
    }
}