...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    ...
    /// - Neutral colors with subtle shadows
    /// - Clean, minimal design
    /// - Sans-serif typography (Inter/Segoe UI)
    /// - Rounded corners & modern look (pairs with ShadcnFormPainter)
    /// </summary>
    public class ShadcnTheme : IBeepTheme
    {
        // Identity
        public string ThemeName { get; } = "ShadcnTheme";
        ...
        public ShadcnTheme()
        {
            // --- Base palette (Shadcn/ui)
            var background = C(250, 250, 250);      // #FAFAFA
            var surface = C(255, 255, 255);         // #FFFFFF
            var foreground = C(9, 9, 11);           // #09090B - near black
            var border = C(229, 229, 229);           // #E5E5E5
            var primary = C(24, 24, 27);            // #18181B - dark gray
            var secondary = C(113, 113, 122);       // #71717A - medium gray
            var accent = C(59, 130, 246);           // #3B82F6 - blue
            var muted = C(245, 245, 245);           // #F5F5F5
            var mutedForeground = C(113, 113, 122); // #71717A
            
            // Theme color aliases (replacing terminal green colors with Shadcn colors)
            ...
            // --- AppBar / Caption (matches ShadcnFormPainter)
            ...
            PaddingMedium = 10;
            PaddingLarge = 16;
            BorderRadius = 8;   // rounded corners for Shadcn
            BorderSize = 1;
            ...
            // Validate and auto-fix contrast issues (Shadcn theme standard contrast)
