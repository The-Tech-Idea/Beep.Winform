...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class UbuntuTheme
    {
        private void ApplyAppBar()
        {
            ...
            this.AppBarSubTitleStyle = new TypographyStyle { FontFamily = "Ubuntu", FontSize = 13f, FontWeight = FontWeight.Normal, FontStyle = FontStyle.Regular, TextColor = SecondaryColor, LineHeight = 1.5f };
