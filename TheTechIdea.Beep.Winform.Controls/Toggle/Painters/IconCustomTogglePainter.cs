...
{
    /// <summary>
    /// Custom icon toggle - allows developers to specify any two SVG image paths
    /// </summary>
    internal class IconCustomTogglePainter : BeepTogglePainterBase
    {
        public IconCustomTogglePainter(BeepToggle owner, BeepToggleLayoutHelper layout)
            : base(owner, layout)
        {
        }
