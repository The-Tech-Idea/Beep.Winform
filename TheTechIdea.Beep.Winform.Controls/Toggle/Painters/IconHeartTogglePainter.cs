...
{
    /// <summary>
    /// Heart icon toggle - shows filled heart (ON/favorited) and heart outline (OFF/not favorited) icons
    /// </summary>
    internal class IconHeartTogglePainter : BeepTogglePainterBase
    {
        public IconHeartTogglePainter(BeepToggle owner, BeepToggleLayoutHelper layout)
            : base(owner, layout)
        {
        }
        ...
        protected override void PaintIcons(Graphics g, ControlState state)
        {
            ...
            {
                iconColor = Color.FromArgb(255, 244, 67, 54); // Material Red for filled heart
            }
            else
            {
