...
namespace TheTechIdea.Beep.Winform.Controls
{
    ...
    public  class BeepTree_backup: BaseControl
    {
        #region "Events"
    ...
    private System.Windows.Forms.Timer _resizeTimer; // debounce resize work
        ...
        { // but the SetStyle gives you full control:
           ...
           MouseDown += OnMouseDownHandler;
            ...
            // Initialize the default painter
            //InitializePainter();
        }
        ...
        protected override void DrawContent(Graphics g)
        {
            ...
            // Let the painter handle overall tree background if available
            //var painter = GetCurrentPainter();
            //if (painter != null && DrawingRect.Width > 0 && DrawingRect.Height > 0)
            //{
        ...
        { // Store original size
            ...
            // Set tree-specific theme colors for painter access
        ...
        private Color _treeBackColor;
        private Color _treeForeColor;
        private Color _treeNodeSelectedBackColor;
        private Color _treeNodeSelectedForeColor;
        private Color _treeNodeHoverBackColor;
        private Color _treeNodeHoverForeColor;
