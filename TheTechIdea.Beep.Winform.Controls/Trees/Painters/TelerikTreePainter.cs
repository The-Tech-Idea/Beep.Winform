    ...
    public class TelerikTreePainter : BaseTreePainter
    {
        ...
        private void PaintDefaultTelerikIcon(Graphics g, Rectangle iconRect)
        {
            ...
            using (var path = new GraphicsPath())
            {
                ...
                using (var brush = new LinearGradientBrush(innerRect, ShiftLuminance(iconColor, 0.2f), ShiftLuminance(iconColor, -0.1f), LinearGradientMode.Vertical))
                {
                ...
                var pen = PaintersFactory.GetPen(ShiftLuminance(iconColor, -0.4f), 1f);
                g.DrawPath(pen, path);
            }
        }
