...
namespace TheTechIdea.Beep.Winform.Controls.VerticalTables.Painters
{
    ...
    public class VerticalTableStyle3Painter : IVerticalTablePainter
    {
        ...
        public void Paint(Graphics g, Rectangle bounds, BindingList<SimpleItem> columns, VerticalTableLayoutHelper layout, object owner)
        {
            ...
            // Light background
            using (var backBrush = new SolidBrush(VerticalTableThemeHelpers.Cur.AltRowBackColor))
            {
            ...
            bool isFeatured)
        {
            ...
            Color checkColor = isFeatured ? BeepStyling.GetThemeColor("accent") : VerticalTableThemeHelpers.Cur.SuccessColor;
            ...
            {
                Color textColor = item.IsEnabled ? VerticalTableThemeHelpers.Cur.GridForeColor : Color.FromArgb(156, 163, 175);
        ...
        private void DrawCTAButton(Graphics g, VerticalColumnLayout col, SimpleItem column, bool isHovered, bool isFeatured)
        {
            ...
            {
                bgColor = accent;
                textColor = VerticalTableThemeHelpers.Cur.GridHeaderSelectedForeColor;
                borderColor = accent;
            }
            else
            {
                bgColor = VerticalTableThemeHelpers.Cur.GridBackColor;
                textColor = accent;
                borderColor = accent;
            }
