...
namespace TheTechIdea.Beep.Winform.Controls.Widgets
{
    ...
    public class BeepFormWidget : BaseControl
    {
        ...
        private Color _textBoxBorderColor = Color.FromArgb(200, 200, 200);
        ...
        private Color _buttonBackColor = Color.FromArgb(33, 150, 243);
        private Color _buttonForeColor = Color.White;
        private Color _buttonBorderColor = Color.FromArgb(33, 150, 243);
        private Color _labelForeColor = Color.Black;
        private Color _helpTextForeColor = Color.FromArgb(100, 100, 100);
