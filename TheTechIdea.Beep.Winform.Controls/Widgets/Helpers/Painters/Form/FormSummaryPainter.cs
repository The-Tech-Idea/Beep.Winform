...
{
    /// <summary>
    /// FormSummary - Form data summary display painter
    /// </summary>
    internal sealed class FormSummaryPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            g.DrawString("Form Summary implementation pending...", font, brush, ctx.DrawingRect);
        }
