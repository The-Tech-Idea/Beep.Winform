...
namespace TheTechIdea.Beep.Winform.Controls.Widgets.Helpers.Painters.Map
{
    ...
    internal sealed class AddressCardPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            var iconFont = FontListHelper.GetFont(Owner.Font.FontFamily.Name, 12f, FontStyle.Bold);
            ...
            // Draw address title
            var titleFont = FontListHelper.GetFont(Owner.Font.FontFamily.Name, 10f, FontStyle.Bold);
            ...
            var addressFont = FontListHelper.GetFont(Owner.Font.FontFamily.Name, 9f, FontStyle.Regular);
            ...
            {
                var coordFont = FontListHelper.GetFont(Owner.Font.FontFamily.Name, 8f, FontStyle.Regular);
