...
{
    /// <summary>
    /// LocationList - List of locations painter
    /// </summary>
    internal sealed class LocationListPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            g.DrawString("Location List implementation pending...", font, brush, ctx.DrawingRect);
        }
