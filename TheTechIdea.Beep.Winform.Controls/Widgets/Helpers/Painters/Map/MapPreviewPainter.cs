...
{
    /// <summary>
    /// MapPreview - Small map preview painter
    /// </summary>
    internal sealed class MapPreviewPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            g.DrawString("Map Preview implementation pending...", font, brush, ctx.DrawingRect);
        }
