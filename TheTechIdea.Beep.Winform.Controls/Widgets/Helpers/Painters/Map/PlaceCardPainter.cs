...
{
    /// <summary>
    /// PlaceCard - Place/venue information painter
    /// </summary>
    internal sealed class PlaceCardPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            g.DrawString("Place Card implementation pending...", font, brush, ctx.DrawingRect);
        }
