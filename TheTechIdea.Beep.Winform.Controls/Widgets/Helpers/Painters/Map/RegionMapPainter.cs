...
{
    /// <summary>
    /// RegionMap - Regional data display painter
    /// </summary>
    internal sealed class RegionMapPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            g.DrawString("Region Map implementation pending...", font, brush, ctx.DrawingRect);
        }
