...
{
    /// <summary>
    /// TravelCard - Travel/shipping card painter
    /// </summary>
    internal sealed class TravelCardPainter : WidgetPainterBase
    {
        ...
        public override void DrawContent(Graphics g, WidgetContext ctx)
        {
            ...
            g.DrawString("Travel Card implementation pending...", font, brush, ctx.DrawingRect);
        }
