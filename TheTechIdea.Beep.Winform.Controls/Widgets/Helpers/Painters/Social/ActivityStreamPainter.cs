...
namespace TheTechIdea.Beep.Winform.Controls.Widgets.Helpers.Painters.Social
{
    ...
    internal sealed class ActivityStreamPainter : WidgetPainterBase, IDisposable
    {
        ...
        private void DrawActivityHeader(Graphics g, Rectangle rect, string title, Color accentColor, int activityCount)
        {
            ...
            var titleFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 11f, FontStyle.Bold);
            ...
            if (activityCount > 0)
            {
                ...
                var countFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name,  9f, FontStyle.Regular);
        ...
        private void DrawActivityTimeline(Graphics g, Rectangle rect, List<ActivityItem> activities)
        {
            ...
            if (activities.Count > maxVisibleItems)
            {
                ...
                var moreFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 8f, FontStyle.Italic);
        ...
        private void DrawActivityItem(Graphics g, Rectangle rect, ActivityItem activity, int timelineX)
        {
            ...
            // Activity text
            var activityFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 9f, FontStyle.Regular);
            ...
            // Timestamp
            var timeFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 8f, FontStyle.Regular);
            ...
            {
                var detailFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 8f, FontStyle.Regular);
        ...
        private void DrawUserAvatar(Graphics g, Rectangle rect, string avatarPath, string userName)
        {
            ...
            else
            {
                ...
                var initialFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 8f, FontStyle.Bold);
        ...
        private void DrawEmptyState(Graphics g, Rectangle rect)
        {
            ...
            // Empty state text
            var emptyFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 10f, FontStyle.Regular);
            ...
            var subFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 9f, FontStyle.Regular);
        ...
        public override void DrawForegroundAccents(Graphics g, WidgetContext ctx)
        {
            ...
            if (activities.Any(a => (DateTime.Now - a.Timestamp).TotalMinutes < 5))
            {
                ...
                var liveFont = FontListHelper.GetFont(Owner.TextFont.FontFamily.Name, 7f, FontStyle.Bold);
