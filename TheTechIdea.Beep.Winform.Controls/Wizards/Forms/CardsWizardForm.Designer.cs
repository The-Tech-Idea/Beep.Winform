...
namespace TheTechIdea.Beep.Winform.Controls.Wizards.Forms
{
    partial class CardsWizardForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            SuspendLayout();
            //
            // _root - the step-card rail on the left, everything else on the right
            //
            _root.ColumnCount = 2;
            _root.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 220F));
            _root.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
            _root.RowCount = 1;
            _root.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            _root.Dock = DockStyle.Fill;
            _root.Name = "_root";
            _root.Controls.Add(_cardPanel, 0, 0);
            ...
            _cardPanel.Margin = new Padding(0);
            _cardPanel.Name = "_cardPanel";
            _cardPanel.Padding = new Padding(10, 15, 10, 15);
            //
            // _contentPanel
            //
