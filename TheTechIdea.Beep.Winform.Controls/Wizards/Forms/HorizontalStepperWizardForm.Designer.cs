...
namespace TheTechIdea.Beep.Winform.Controls.Wizards.Forms
{
    partial class HorizontalStepperWizardForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            SuspendLayout();
            //
            // _root - step indicator, progress bar, error, content, buttons
            //
            _root.ColumnCount = 1;
            ...
            // _stepIndicatorPanel
            //
            // The framework's stepper, not a Panel with a Paint handler.
            //
            // The band used to be an empty Panel whose entire appearance came from
            // StepIndicatorPanel_Paint - several hundred lines of hand-drawn circles, connectors
            // and labels in HorizontalStepperPainter. BeepStepperBar already draws all of it, is
            // themed, hit-testable and keyboard-navigable, and shows on the design surface.
            _stepper.Dock = DockStyle.Fill;
            _stepper.Margin = new Padding(0);
            _stepper.Name = "_stepper";
            _stepper.Orientation = Orientation.Horizontal;
            //
            // _progressBar
            //
