...
{
    [AddinAttribute(Caption = "Big Data Connections", Name = "uc_BigDataConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 8, RootNodeName = "Configuration", Order = 8, ID = 8, BranchText = "Big Data Connections", BranchType = EnumPointType.Function, IconImageName = "bigdataconnections.svg", BranchClass = "ADDIN", BranchDescription = "Big Data Platform Connections Setup Screen")]

    public partial class uc_BigDataConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_BigDataConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "Big Data Connections";
        }
        ...
        public string BranchText { get; set; } = "Big Data Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 8;
        public string IconImageName { get; set; } = "bigdataconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "Big Data Platform Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        BigDataConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to Big Data connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new BigDataConnectionViewModel(beepService.DMEEditor, beepService.vis);
            viewModel.DBWork.Units.Filter = $"Category = {DatasourceCategory.BigData}";
