...
{
    [AddinAttribute(Caption = "Cloud Connections", Name = "uc_CloudConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 6, RootNodeName = "Configuration", Order = 6, ID = 6, BranchText = "Cloud Connections", BranchType = EnumPointType.Function, IconImageName = "cloudconnections.svg", BranchClass = "ADDIN", BranchDescription = "Cloud Service Connections Setup Screen")]

    public partial class uc_CloudConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_CloudConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "Cloud Connections";
        }
        ...
        public string BranchText { get; set; } = "Cloud Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 6;
        public string IconImageName { get; set; } = "cloudconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "Cloud Service Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        CloudConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to Cloud connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new CloudConnectionViewModel(beepService.DMEEditor, beepService.vis);
            viewModel.DBWork.Units.Filter = $"Category = {DatasourceCategory.CLOUD}";
