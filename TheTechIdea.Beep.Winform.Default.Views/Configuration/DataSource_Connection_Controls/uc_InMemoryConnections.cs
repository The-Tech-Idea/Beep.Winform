...
{
    [AddinAttribute(Caption = "In-Memory Connections", Name = "uc_InMemoryConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 7, RootNodeName = "Configuration", Order = 7, ID = 7, BranchText = "In-Memory Connections", BranchType = EnumPointType.Function, IconImageName = "inmemoryconnections.svg", BranchClass = "ADDIN", BranchDescription = "In-Memory Database Connections Setup Screen")]

    public partial class uc_InMemoryConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_InMemoryConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "In-Memory Connections";
        }
        ...
        public string BranchText { get; set; } = "In-Memory Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 7;
        public string IconImageName { get; set; } = "inmemoryconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "In-Memory Database Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        InMemoryConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to In-Memory connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new InMemoryConnectionViewModel(beepService.DMEEditor, beepService.vis);
            viewModel.DBWork.Units.Filter = $"Category = {DatasourceCategory.INMEMORY}";
