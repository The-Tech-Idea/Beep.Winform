...
{
    [AddinAttribute(Caption = "MySQL Connections", Name = "uc_MySqlConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 11, RootNodeName = "Configuration", Order = 11, ID = 11, BranchText = "MySQL Connections", BranchType = EnumPointType.Function, IconImageName = "mysqlconnections.svg", BranchClass = "ADDIN", BranchDescription = "MySQL Database Connections Setup Screen")]

    public partial class uc_MySqlConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_MySqlConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "MySQL Connections";
        }
        ...
        public string BranchText { get; set; } = "MySQL Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 11;
        public string IconImageName { get; set; } = "mysqlconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "MySQL Database Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        MySqlConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to MySQL connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new MySqlConnectionViewModel(beepService.DMEEditor, beepService.vis);
