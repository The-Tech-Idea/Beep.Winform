...
{
    public partial class uc_OracleConnections : TemplateUserControl
    {
        OracleConnectionViewModel viewModel;

        public uc_OracleConnections()
        {
            InitializeComponent();
        }

        private void uc_OracleConnections_Load(object sender, EventArgs e)
        {
            Configure();
        }
        ...
        {
            viewModel = new OracleConnectionViewModel(Editor, VisManager);
            ...
            textBoxServiceName.DataBindings.Add("Text", viewModel, "ServiceName", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxTnsName.DataBindings.Add("Text", viewModel, "TnsName", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxSid.DataBindings.Add("Text", viewModel, "Sid", true, DataSourceUpdateMode.OnPropertyChanged);
            ...
            checkBoxPersistSecurityInfo.DataBindings.Add("Checked", viewModel, "PersistSecurityInfo", true, DataSourceUpdateMode.OnPropertyChanged);
            checkBoxIntegratedSecurity.DataBindings.Add("Checked", viewModel, "IntegratedSecurity", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxWalletLocation.DataBindings.Add("Text", viewModel, "WalletLocation", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxWalletPassword.DataBindings.Add("Text", viewModel, "WalletPassword", true, DataSourceUpdateMode.OnPropertyChanged);
            checkBoxSsl.DataBindings.Add("Checked", viewModel, "Ssl", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxSslServerCertDn.DataBindings.Add("Text", viewModel, "SslServerCertDn", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxSslServerDnMatch.DataBindings.Add("Text", viewModel, "SslServerDnMatch", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxApplicationEdition.DataBindings.Add("Text", viewModel, "ApplicationEdition", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxProxyUserId.DataBindings.Add("Text", viewModel, "ProxyUserId", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxProxyPassword.DataBindings.Add("Text", viewModel, "ProxyPassword", true, DataSourceUpdateMode.OnPropertyChanged);
            checkBoxStatementCachePurge.DataBindings.Add("Checked", viewModel, "StatementCachePurge", true, DataSourceUpdateMode.OnPropertyChanged);
            checkBoxStatementCacheWithUdts.DataBindings.Add("Checked", viewModel, "StatementCacheWithUdts", true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDownStatementCacheSize.DataBindings.Add("Value", viewModel, "StatementCacheSize", true, DataSourceUpdateMode.OnPropertyChanged);
            checkBoxSelfTuning.DataBindings.Add("Checked", viewModel, "SelfTuning", true, DataSourceUpdateMode.OnPropertyChanged);
            numericUpDownFetchSize.DataBindings.Add("Value", viewModel, "FetchSize", true, DataSourceUpdateMode.OnPropertyChanged);
            checkBoxOciCompartment.DataBindings.Add("Checked", viewModel, "OciCompartment", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxOciRegion.DataBindings.Add("Text", viewModel, "OciRegion", true, DataSourceUpdateMode.OnPropertyChanged);
            textBoxOciTenancy.DataBindings.Add("Text", viewModel, "OciTenancy", true, DataSourceUpdateMode.OnPropertyChanged);

            // Setup driver type dropdown
            comboBoxDriverType.DataSource = viewModel.OracleDatabaseTypes;
            comboBoxDriverType.DisplayMember = "PackageName";
            comboBoxDriverType.ValueMember = "PackageName";
            comboBoxDriverType.DataBindings.Add("SelectedItem", viewModel, "SelectedOracleDatabaseType", true, DataSourceUpdateMode.OnPropertyChanged);
