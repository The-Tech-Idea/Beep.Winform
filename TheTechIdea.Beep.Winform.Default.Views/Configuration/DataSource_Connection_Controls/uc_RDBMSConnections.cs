...
namespace TheTechIdea.Beep.Winform.Default.Views.Configuration
{
    ...
    [AddinVisSchema(BranchID = 5, RootNodeName = "Configuration", Order = 5, ID = 5, BranchText = "RDBMS Connections", BranchType = EnumPointType.Function, IconImageName = "rdbmsconnections.svg", BranchClass = "ADDIN", BranchDescription = "RDBMS Database Connections Setup Screen")]
    ...
    public partial class uc_RDBMSConnections : TemplateUserControl, IAddinVisSchema
    {
        ...
        public string BranchDescription { get; set; } = "RDBMS Database Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        RDBMSConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to RDBMS connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new RDBMSConnectionViewModel(beepService.DMEEditor, beepService.vis);
