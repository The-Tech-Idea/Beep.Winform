...
{
    [AddinAttribute(Caption = "SQL Server Connections", Name = "uc_SqlServerConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 10, RootNodeName = "Configuration", Order = 10, ID = 10, BranchText = "SQL Server Connections", BranchType = EnumPointType.Function, IconImageName = "sqlserverconnections.svg", BranchClass = "ADDIN", BranchDescription = "SQL Server Database Connections Setup Screen")]

    public partial class uc_SqlServerConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_SqlServerConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "SQL Server Connections";
        }
        ...
        public string BranchText { get; set; } = "SQL Server Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 10;
        public string IconImageName { get; set; } = "sqlserverconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "SQL Server Database Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        SqlServerConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to SQL Server connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new SqlServerConnectionViewModel(beepService.DMEEditor, beepService.vis);
