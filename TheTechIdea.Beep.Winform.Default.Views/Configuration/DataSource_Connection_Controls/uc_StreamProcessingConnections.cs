...
{
    [AddinAttribute(Caption = "Stream Processing Connections", Name = "uc_StreamProcessingConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 9, RootNodeName = "Configuration", Order = 9, ID = 9, BranchText = "Stream Processing Connections", BranchType = EnumPointType.Function, IconImageName = "streamprocessingconnections.svg", BranchClass = "ADDIN", BranchDescription = "Stream Processing and Messaging Connections Setup Screen")]

    public partial class uc_StreamProcessingConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_StreamProcessingConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "Stream Processing Connections";
        }
        ...
        public string BranchText { get; set; } = "Stream Processing Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 9;
        public string IconImageName { get; set; } = "streamprocessingconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "Stream Processing and Messaging Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        StreamProcessingConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to Stream Processing connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new StreamProcessingConnectionViewModel(beepService.DMEEditor, beepService.vis);
            viewModel.DBWork.Units.Filter = $"Category IN ({(int)DatasourceCategory.STREAM}, {(int)DatasourceCategory.QUEUE}, {(int)DatasourceCategory.StreamProcessing})";
