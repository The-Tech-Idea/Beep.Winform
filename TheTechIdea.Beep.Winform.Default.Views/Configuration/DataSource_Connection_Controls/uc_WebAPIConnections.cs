...
{
    [AddinAttribute(Caption = "WebAPI Connections", Name = "uc_WebAPIConnections", misc = "Config", menu = "Configuration", addinType = AddinType.Control, displayType = DisplayType.InControl, ObjectType = "Beep")]
    [AddinVisSchema(BranchID = 4, RootNodeName = "Configuration", Order = 4, ID = 4, BranchText = "WebAPI Connections", BranchType = EnumPointType.Function, IconImageName = "webapiconnections.svg", BranchClass = "ADDIN", BranchDescription = "WebAPI Connections Setup Screen")]

    public partial class uc_WebAPIConnections : TemplateUserControl, IAddinVisSchema
    {
        public uc_WebAPIConnections(IServiceProvider services): base(services)
        {
            InitializeComponent();

            Details.AddinName = "WebAPI Connections";
        }
        ...
        public string BranchText { get; set; } = "WebAPI Connections";
        public int Level { get; set; }
        public EnumPointType BranchType { get; set; } = EnumPointType.Function;
        public int BranchID { get; set; } = 4;
        public string IconImageName { get; set; } = "webapiconnections.svg";
        public string BranchStatus { get; set; }
        public int ParentBranchID { get; set; }
        public string BranchDescription { get; set; } = "WebAPI Connections Setup Screen";
        public string BranchClass { get; set; } = "ADDIN";
        public string AddinName { get; set; }
        #endregion "IAddinVisSchema"

        WebAPIConnectionViewModel viewModel;
        ...
        {
            // Handle cell value changes specific to WebAPI connections
        ...
        public override void Configure(Dictionary<string, object> settings)
        {
            ...
            viewModel = new WebAPIConnectionViewModel(beepService.DMEEditor, beepService.vis);
            viewModel.DBWork.Units.Filter = "Category = " + DatasourceCategory.WEBAPI;
