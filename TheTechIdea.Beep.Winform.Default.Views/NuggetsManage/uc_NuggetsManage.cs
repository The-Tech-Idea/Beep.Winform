...
namespace TheTechIdea.Beep.Winform.Default.Views.NuggetsManage
{
    ...
    public class uc_NuggetsManage : UserControl
    {
        ...
        {
            Details.AddinName = "Nuggets Manager";
        ...
        private void RefreshNuggetList()
        {
            ...
            // Re-check state entries for missing paths and persist health status.
        ...
        private void AppendLog(NuggetOperationSeverity severity, string message)
        {
            ...
            if (Editor != null)
            {
                ...
                Editor.AddLogMessage("NuggetsManage", message, DateTime.Now, 0, null, flag);
            }
        }
