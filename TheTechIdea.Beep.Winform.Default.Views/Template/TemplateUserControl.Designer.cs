namespace TheTechIdea.Beep.Winform.Default.Views.Template
{
    partial class TemplateUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            MainTemplatePanel.AnimationType = Vis.Modules.DisplayAnimationType.None;
            MainTemplatePanel.ApplyThemeToChilds = true;
            MainTemplatePanel.BackColor = Color.FromArgb(255, 255, 255);
            MainTemplatePanel.BadgeBackColor = Color.Red;
            MainTemplatePanel.BadgeFont = new Font("Arial", 8F, FontStyle.Bold);
            MainTemplatePanel.BadgeForeColor = Color.White;
            MainTemplatePanel.BadgeShape = Vis.Modules.BadgeShape.Circle;
            MainTemplatePanel.BadgeText = "";
            MainTemplatePanel.BlockID = null;
            MainTemplatePanel.BorderColor = Color.Black;
            MainTemplatePanel.BorderDashStyle = System.Drawing.Drawing2D.DashStyle.Solid;
            MainTemplatePanel.BorderRadius = 8;
            ...
            MainTemplatePanel.DisabledBackColor = Color.White;
            MainTemplatePanel.DisabledForeColor = Color.Black;
            ...
            MainTemplatePanel.GradientEndColor = Color.Gray;
            MainTemplatePanel.GradientStartColor = Color.Gray;
            ...
            MainTemplatePanel.HoverBackColor = Color.White;
            ...
            MainTemplatePanel.IsVisible = false;
            ...
            MainTemplatePanel.OverrideFontSize = Vis.Modules.TypeStyleFontSize.None;
            ...
            MainTemplatePanel.ShadowColor = Color.Black;
            MainTemplatePanel.ShadowOffset = 0;
            MainTemplatePanel.ShadowOpacity = 0.5F;
            ...
            MainTemplatePanel.SlideFrom = Vis.Modules.SlideDirection.Left;
