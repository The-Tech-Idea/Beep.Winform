...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class HighlightTheme
    {
        ...
        public Color PrimaryTextColor { get; set; } = Color.FromArgb(33, 33, 33);
        public Color SecondaryTextColor { get; set; } = Color.FromArgb(117, 117, 117);
        public Color AccentTextColor { get; set; } = Color.FromArgb(0, 120, 215);
        ...
        public Color ShadowColor { get; set; } = Color.FromArgb(64, 0, 0, 0);
        public float ShadowOpacity { get; set; } = 0.5f;
        public double AnimationDurationShort { get; set; } = 150;
        public double AnimationDurationMedium { get; set; } = 300;
        public double AnimationDurationLong { get; set; } = 600;
