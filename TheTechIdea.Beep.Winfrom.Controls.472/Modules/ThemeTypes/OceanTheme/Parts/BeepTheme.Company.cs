...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class OceanTheme
    {
        ...
        public TypographyStyle CompanyTitleFont { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.FromArgb(0, 80, 120) };
        public Color CompanySubtitleColor { get; set; } = Color.FromArgb(0, 105, 148);
        public TypographyStyle CompanySubTitleFont { get; set; } = new TypographyStyle() { FontSize = 12f, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(0, 105, 148) };
        public Color CompanyDescriptionColor { get; set; } = Color.FromArgb(0, 130, 180);
        public TypographyStyle CompanyDescriptionFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(0, 130, 180) };
        public Color CompanyLinkColor { get; set; } = Color.FromArgb(0, 150, 200);
        public TypographyStyle CompanyLinkFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(0, 150, 200), IsUnderlined = true };
