...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class OceanTheme
    {
        ...
        public TypographyStyle ScrollListTitleFont { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.White };
        ...
        public TypographyStyle ScrollListUnSelectedFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(200, 255, 255) };
        ...
        public TypographyStyle ScrollListIItemFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(200, 255, 255) };
