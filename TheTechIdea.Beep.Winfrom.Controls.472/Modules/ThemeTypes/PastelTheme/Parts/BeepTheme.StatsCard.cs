...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class PastelTheme
    {
        ...
        public TypographyStyle StatsTitleFont { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.FromArgb(80, 80, 80) };
        ...
        public TypographyStyle StatsUnSelectedFont { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(120, 120, 120) };
        ...
        public TypographyStyle StatsCardTitleStyle { get; set; } = new TypographyStyle() { FontSize = 14f, FontWeight = FontWeight.Bold, TextColor = Color.FromArgb(80, 80, 80) };
        ...
        public TypographyStyle StatsCardSubStyleStyle { get; set; } = new TypographyStyle() { FontSize = 12f, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(120, 120, 120) };
        ...
        public TypographyStyle StatsCardValueStyle { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Bold, TextColor = Color.FromArgb(80, 80, 80) };
        ...
        public TypographyStyle StatsCardInfoStyle { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Regular, TextColor = Color.FromArgb(120, 120, 120) };
        ...
        public TypographyStyle StatsCardTrendStyle { get; set; } = new TypographyStyle() { FontSize = 8f, FontWeight = FontWeight.Medium, TextColor = Color.FromArgb(245, 183, 203) };
    }
}
