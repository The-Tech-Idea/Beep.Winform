...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class WinterTheme
    {
        ...
        public Color ButtonSelectedBackColor { get; set; } = Color.FromArgb(60, 115, 165);
        ...
        public Color ButtonBackColor { get; set; } = Color.FromArgb(210, 228, 245); // lighter icy plate
        public Color ButtonForeColor { get; set; } = Color.FromArgb(35, 60, 95);    // deep slate text
        public Color ButtonBorderColor { get; set; } = Color.FromArgb(120, 165, 210); // medium ice border
        ...
        public Color ButtonPressedBackColor { get; set; } = Color.FromArgb(175, 205, 235);
        public Color ButtonPressedForeColor { get; set; } = Color.FromArgb(28, 50, 80);
        public Color ButtonPressedBorderColor { get; set; } = Color.FromArgb(100, 150, 195);
    }
}
