...
namespace TheTechIdea.Beep.Vis.Modules
{
    public partial class ZenTheme
    {
        ...
        public Color PrimaryTextColor { get; set; } = Color.FromArgb(34, 34, 34);
        public Color SecondaryTextColor { get; set; } = Color.FromArgb(189, 189, 189);
        public Color AccentTextColor { get; set; } = Color.FromArgb(76, 175, 80);
        ...
        public Color FocusIndicatorColor { get; set; } = Color.FromArgb(76, 175, 80);
