...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class MacOSTheme
    {
        private void ApplyGrid()
        {
            ...
            this.GridHeaderBorderColor = Color.FromArgb(229,229,234);
            ...
            this.GridHeaderHoverBorderColor = Color.FromArgb(229,229,234);
            this.GridHeaderSelectedBorderColor = Color.FromArgb(229,229,234);
            ...
            this.GridRowHoverBorderColor = Color.FromArgb(229,229,234);
            this.GridRowSelectedBorderColor = Color.FromArgb(229,229,234);
