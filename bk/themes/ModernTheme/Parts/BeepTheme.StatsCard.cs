...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class ModernTheme
    {
        private void ApplyStatsCard()
        {
            ...
            this.StatsCardBorderColor = Color.FromArgb(203,213,225);
