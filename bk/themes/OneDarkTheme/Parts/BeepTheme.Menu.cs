...
namespace TheTechIdea.Beep.Winform.Controls.Themes
{
    public sealed partial class OneDarkTheme
    {
        private void ApplyMenu()
        {
            ...
            this.MenuGradiantStartColor = Color.FromArgb(40,44,52);
            this.MenuGradiantEndColor = Color.FromArgb(40,44,52);
            this.MenuGradiantMiddleColor = Color.FromArgb(40,44,52);
